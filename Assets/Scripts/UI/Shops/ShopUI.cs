...
namespace RPG.UI.Shops
{
    public class ShopUI : MonoBehaviour
    {
        ...
        Color originalTotalextColor;

        private void Start()
        {
            originalTotalextColor=totalField.color;
        ...
        private void ShopChanged()
        {
            ...
            currentShop = shopper.GetAciveShop();
        ...
        private void RefreshUI()
        {
            ...
            totalField.color = currentShop.HasSufficientFunds() ? originalTotalextColor : Color.red;
